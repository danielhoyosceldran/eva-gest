...
public static class Indicators
{
    ...
    public static decimal? WorkPercentage(int workerCents, int periodTotalCents)
    ...
    public static decimal? ProductsPercentage(int productsCents, int workerCents)
    ...
    public static decimal? AveragePerVisit(int totalSpentCents, int completedVisits)
